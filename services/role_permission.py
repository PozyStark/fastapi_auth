...
class RolePermissionService:
    ...
    async def find_role_permissions_by_id(self, role_id: int):
        result = await self.repository.find_role_permissions_by_name(role_id)
        return result
    
    async def find_role_permissions_by_name(self, role_name: str):
        result = await self.repository.find_role_permissions_by_name(role_name)
        return result
